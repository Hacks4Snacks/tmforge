namespace ThreatModelForge.Cli
{
    ...
    internal static class CommandCatalog
    {
        private static readonly IReadOnlyList<CommandInfo> All = new List<CommandInfo>
        {
            ...
            new CommandInfo("threats", "Report threats: the persisted, triaged view of the analysis findings (--write to persist).", "summary{count,written}, threats[]{id,ruleId,category,title,mitigation,severity,references[],scope,interaction}", ThreatsCommand.Run),
