...
| --- | --- | --- | :---: | :---: | :---: |
| `tm7` | `.tm7` | Microsoft Threat Modeling Tool | ✅ | ✅ | ✅ **lossless** |
| `tmforge-json` | `.tmforge.json` | Threat Model Forge JSON (canvas wire model) | ✅ | ✅ | structural |
...
registry rather than any single format, so adding one doesn't touch the CLI, API, or Studio. See
[ADR 0003 — multi-format extensibility](adr/0003-multi-format-extensibility.md).

## See also

- [CLI reference — `convert`](cli-reference.md#convert)
- [Engine API reference](api-reference.md)
- [ADR 0011 — Threat Dragon / draw.io provider](adr/0011-threat-dragon-format-provider.md),
  [ADR 0012 — Visio interoperability](adr/0012-visio-vsdx-interoperability.md)
